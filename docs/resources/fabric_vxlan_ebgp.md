...
page_title: "nd_fabric_vxlan_ebgp Resource - terraform-provider-nd"
subcategory: ""
description: |-
  
---

# nd_fabric_vxlan_ebgp (Resource)
...
- `fabric_name` (String) The name of the fabric_vxlan_ebgp resource
...
- `id` (String) The unique identifier of the fabric_vxlan_ebgp resource
