...
func (v *FabricVxlanEbgpModel) SetModelData(jsonData *resource_fabric_common.NDFCFabricCommonModel) diag.Diagnostics {
...
func (v FabricVxlanEbgpModel) GetModelData() *resource_fabric_common.NDFCFabricCommonModel {
	...
	if !v.BgpAsnAutoAllocation.IsNull() && !v.BgpAsnAutoAllocation.IsUnknown() {
		data.Management.BgpAsnAutoAllocation = new(bool)
		*data.Management.BgpAsnAutoAllocation = v.BgpAsnAutoAllocation.ValueBool()
	} else {
		data.Management.BgpAsnAutoAllocation = nil
	}

	if !v.BgpAsnRange.IsNull() && !v.BgpAsnRange.IsUnknown() {
		data.Management.BgpAsnRange = v.BgpAsnRange.ValueString()
	} else {
		data.Management.BgpAsnRange = ""
	}

	if !v.BgpAllowAsInNum.IsNull() && !v.BgpAllowAsInNum.IsUnknown() {
		data.Management.BgpAllowAsInNum = new(int64)
		*data.Management.BgpAllowAsInNum = v.BgpAllowAsInNum.ValueInt64()

	} else {
		data.Management.BgpAllowAsInNum = nil
	}

	if !v.BgpMaxPath.IsNull() && !v.BgpMaxPath.IsUnknown() {
		data.Management.BgpMaxPath = new(int64)
		*data.Management.BgpMaxPath = v.BgpMaxPath.ValueInt64()

	} else {
		data.Management.BgpMaxPath = nil
	}

	if !v.BgpUnderlayFailureProtect.IsNull() && !v.BgpUnderlayFailureProtect.IsUnknown() {
		data.Management.BgpUnderlayFailureProtect = new(bool)
		*data.Management.BgpUnderlayFailureProtect = v.BgpUnderlayFailureProtect.ValueBool()
	} else {
		data.Management.BgpUnderlayFailureProtect = nil
	}

	if !v.AutoConfigureEbgpEvpnPeering.IsNull() && !v.AutoConfigureEbgpEvpnPeering.IsUnknown() {
		data.Management.AutoConfigureEbgpEvpnPeering = new(bool)
		*data.Management.AutoConfigureEbgpEvpnPeering = v.AutoConfigureEbgpEvpnPeering.ValueBool()
	} else {
		data.Management.AutoConfigureEbgpEvpnPeering = nil
	}

	if !v.AllowLeafSameAs.IsNull() && !v.AllowLeafSameAs.IsUnknown() {
		data.Management.AllowLeafSameAs = new(bool)
		*data.Management.AllowLeafSameAs = v.AllowLeafSameAs.ValueBool()
	} else {
		data.Management.AllowLeafSameAs = nil
	}

	if !v.AssignIpv4ToLoopback0.IsNull() && !v.AssignIpv4ToLoopback0.IsUnknown() {
		data.Management.AssignIpv4ToLoopback0 = new(bool)
		*data.Management.AssignIpv4ToLoopback0 = v.AssignIpv4ToLoopback0.ValueBool()
	} else {
		data.Management.AssignIpv4ToLoopback0 = nil
	}
