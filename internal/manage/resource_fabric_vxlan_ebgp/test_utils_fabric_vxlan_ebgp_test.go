...
func FabricVxlanEbgpModelHelperStateCheck(RscName string, c resource_fabric_common.NDFCFabricCommonModel, attrPath path.Path) []resource.TestCheckFunc {
	...
	if c.BgpAsnAutoAllocation != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("bgp_asn_auto_allocation").String(), strconv.FormatBool(*c.BgpAsnAutoAllocation)))
	} else {
	...
	if c.BgpUnderlayFailureProtect != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("bgp_underlay_failure_protect").String(), strconv.FormatBool(*c.BgpUnderlayFailureProtect)))
	} else {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("bgp_underlay_failure_protect").String(), "false"))
	}
	if c.AutoConfigureEbgpEvpnPeering != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("auto_configure_ebgp_evpn_peering").String(), strconv.FormatBool(*c.AutoConfigureEbgpEvpnPeering)))
	} else {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("auto_configure_ebgp_evpn_peering").String(), "true"))
	}
	if c.AllowLeafSameAs != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("allow_leaf_same_as").String(), strconv.FormatBool(*c.AllowLeafSameAs)))
	} else {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("allow_leaf_same_as").String(), "false"))
	}
	if c.AssignIpv4ToLoopback0 != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("assign_ipv4_to_loopback0").String(), strconv.FormatBool(*c.AssignIpv4ToLoopback0)))
	}
	...
	if c.AllowSmartSwitchOnboarding != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("allow_smart_switch_onboarding").String(), strconv.FormatBool(*c.AllowSmartSwitchOnboarding)))
	} else {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("allow_smart_switch_onboarding").String(), "false"))
	}
	if c.EnableDpuPinning != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("enable_dpu_pinning").String(), strconv.FormatBool(*c.EnableDpuPinning)))
	}
...
func NetflowExporterCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCNetflowExporterCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func NetflowRecordCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCNetflowRecordCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func NetflowMonitorCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCNetflowMonitorCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func NetflowSamplerCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCNetflowSamplerCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func VrfFlowRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCVrfFlowRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func InterfaceFlowRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCInterfaceFlowRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func L3OutFlowRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCL3OutFlowRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func InterfaceRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCInterfaceRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func EmailValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCEmailValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func MessageBusValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ebgp.NDFCMessageBusValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
