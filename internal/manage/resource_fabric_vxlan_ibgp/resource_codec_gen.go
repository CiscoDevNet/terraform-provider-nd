...
func (v *FabricVxlanIbgpModel) SetModelData(jsonData *resource_fabric_common.NDFCFabricCommonModel) diag.Diagnostics {
...
func (v FabricVxlanIbgpModel) GetModelData() *resource_fabric_common.NDFCFabricCommonModel {
	...
	if !v.UnderlayMulticastGroupAddressLimit.IsNull() && !v.UnderlayMulticastGroupAddressLimit.IsUnknown() {
		data.Management.UnderlayMulticastGroupAddressLimit = new(int64)
		*data.Management.UnderlayMulticastGroupAddressLimit = v.UnderlayMulticastGroupAddressLimit.ValueInt64()

	} else {
		data.Management.UnderlayMulticastGroupAddressLimit = nil
	}
	...
	if !v.EnablePeerSwitch.IsNull() && !v.EnablePeerSwitch.IsUnknown() {
		data.Management.EnablePeerSwitch = new(bool)
		*data.Management.EnablePeerSwitch = v.EnablePeerSwitch.ValueBool()
	} else {
		data.Management.EnablePeerSwitch = nil
	}
	...
	if !v.Dlb.IsNull() && !v.Dlb.IsUnknown() {
		data.Management.Dlb = new(bool)
		*data.Management.Dlb = v.Dlb.ValueBool()
	} else {
		data.Management.Dlb = nil
	}

	if !v.DlbMode.IsNull() && !v.DlbMode.IsUnknown() {
		data.Management.DlbMode = v.DlbMode.ValueString()
	} else {
		data.Management.DlbMode = ""
	}

	if !v.DlbMixedModeDefault.IsNull() && !v.DlbMixedModeDefault.IsUnknown() {
		data.Management.DlbMixedModeDefault = v.DlbMixedModeDefault.ValueString()
	} else {
		data.Management.DlbMixedModeDefault = ""
	}

	if !v.FlowletAging.IsNull() && !v.FlowletAging.IsUnknown() {
		data.Management.FlowletAging = new(int64)
		*data.Management.FlowletAging = v.FlowletAging.ValueInt64()

	} else {
		data.Management.FlowletAging = nil
	}

	if !v.FlowletDscp.IsNull() && !v.FlowletDscp.IsUnknown() {
		data.Management.FlowletDscp = v.FlowletDscp.ValueString()
	} else {
		data.Management.FlowletDscp = ""
	}

	if !v.PerPacketDscp.IsNull() && !v.PerPacketDscp.IsUnknown() {
		data.Management.PerPacketDscp = v.PerPacketDscp.ValueString()
	} else {
		data.Management.PerPacketDscp = ""
	}

	if !v.AiLoadSharing.IsNull() && !v.AiLoadSharing.IsUnknown() {
		data.Management.AiLoadSharing = new(bool)
		*data.Management.AiLoadSharing = v.AiLoadSharing.ValueBool()
	} else {
		data.Management.AiLoadSharing = nil
	}

	if !v.RoceV2.IsNull() && !v.RoceV2.IsUnknown() {
		data.Management.RoceV2 = v.RoceV2.ValueString()
	} else {
		data.Management.RoceV2 = ""
	}

	if !v.Cnp.IsNull() && !v.Cnp.IsUnknown() {
		data.Management.Cnp = v.Cnp.ValueString()
	} else {
		data.Management.Cnp = ""
	}

	if !v.WredMin.IsNull() && !v.WredMin.IsUnknown() {
		data.Management.WredMin = new(int64)
		*data.Management.WredMin = v.WredMin.ValueInt64()

	} else {
		data.Management.WredMin = nil
	}

	if !v.WredMax.IsNull() && !v.WredMax.IsUnknown() {
		data.Management.WredMax = new(int64)
		*data.Management.WredMax = v.WredMax.ValueInt64()

	} else {
		data.Management.WredMax = nil
	}

	if !v.WredDropProbability.IsNull() && !v.WredDropProbability.IsUnknown() {
		data.Management.WredDropProbability = new(int64)
		*data.Management.WredDropProbability = v.WredDropProbability.ValueInt64()

	} else {
		data.Management.WredDropProbability = nil
	}

	if !v.WredWeight.IsNull() && !v.WredWeight.IsUnknown() {
		data.Management.WredWeight = new(int64)
		*data.Management.WredWeight = v.WredWeight.ValueInt64()

	} else {
		data.Management.WredWeight = nil
	}

	if !v.BandwidthRemaining.IsNull() && !v.BandwidthRemaining.IsUnknown() {
		data.Management.BandwidthRemaining = new(int64)
		*data.Management.BandwidthRemaining = v.BandwidthRemaining.ValueInt64()

	} else {
		data.Management.BandwidthRemaining = nil
	}
	...
	if !v.SecurityGroupTagMacSegmentation.IsNull() && !v.SecurityGroupTagMacSegmentation.IsUnknown() {
		data.Management.SecurityGroupTagMacSegmentation = new(bool)
		*data.Management.SecurityGroupTagMacSegmentation = v.SecurityGroupTagMacSegmentation.ValueBool()
	} else {
		data.Management.SecurityGroupTagMacSegmentation = nil
	}
	...
	if !v.NetflowSamplerCollection.IsNull() && !v.NetflowSamplerCollection.IsUnknown() {
		...
		data.Management.NetflowSettings.NetflowSamplerCollection = make([]resource_fabric_common.NDFCNetflowSamplerCollectionValue, len(v.NetflowSamplerCollection.Elements()))
