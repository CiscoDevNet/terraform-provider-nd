...
func FabricVxlanIbgpModelHelperStateCheck(RscName string, c resource_fabric_common.NDFCFabricCommonModel, attrPath path.Path) []resource.TestCheckFunc {
	...
	if c.EnablePeerSwitch != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("enable_peer_switch").String(), strconv.FormatBool(*c.EnablePeerSwitch)))
	} else {
	...
	if c.Dlb != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("dlb").String(), strconv.FormatBool(*c.Dlb)))
	} else {
	...
	if c.AiLoadSharing != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("ai_load_sharing").String(), strconv.FormatBool(*c.AiLoadSharing)))
	} else {
	...
	if c.SecurityGroupTagMacSegmentation != nil {
		ret = append(ret, resource.TestCheckResourceAttr(RscName, attrPath.AtName("security_group_tag_mac_segmentation").String(), strconv.FormatBool(*c.SecurityGroupTagMacSegmentation)))
	}
...
func BootstrapSubnetCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCBootstrapSubnetCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func NetflowExporterCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCNetflowExporterCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func NetflowRecordCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCNetflowRecordCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func NetflowMonitorCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCNetflowMonitorCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func NetflowSamplerCollectionValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCNetflowSamplerCollectionValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func VrfFlowRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCVrfFlowRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func InterfaceFlowRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCInterfaceFlowRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func L3OutFlowRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCL3OutFlowRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func InterfaceRulesValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCInterfaceRulesValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func EmailValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCEmailValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
...
func MessageBusValueHelperStateCheck(RscName string, c resource_fabric_vxlan_ibgp.NDFCMessageBusValue, attrPath path.Path) []resource.TestCheckFunc {
	ret := []resource.TestCheckFunc{}
