		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.nd_multi_cluster_connectivity.onboard_nd", "hostname", "198.18.133.203"),
					resource.TestCheckResourceAttr("data.nd_multi_cluster_connectivity.onboard_nd", "type", "nd"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.nd_multi_cluster_connectivity.onboard_apic", "hostname", "198.18.133.101"),
					resource.TestCheckResourceAttr("data.nd_multi_cluster_connectivity.onboard_apic", "type", "apic"),
