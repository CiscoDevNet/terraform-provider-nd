		...
		Steps: []resource.TestStep{
			// Create
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("nd_multi_cluster_connectivity.onboard_nd", "cluster_password", "password"),
				),
			},
		...
		Steps: []resource.TestStep{
			// Create
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("nd_multi_cluster_connectivity.onboard_apic", "cluster_password", "password"),
