...
func TenantDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				Required:            true,
				Description:         "The name that uniquely identifies the tenant datasource.",
				MarkdownDescription: "The name that uniquely identifies the tenant datasource.",
			},
		},
		Description:         "Datasource of the tenant and its fabric associations for Nexus Dashboard",
		MarkdownDescription: "Datasource of the tenant and its fabric associations for Nexus Dashboard",
	}
}
